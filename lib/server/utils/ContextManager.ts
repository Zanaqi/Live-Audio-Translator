...
export class ContextManager {
  ...
  constructor(initialDomain: string) {
    ...
    this.domainKeywords = new Map([
      [
        "museum_tour",
        ["museum", "exhibit", "collection", "curator", "display", "gallery"],
      ],
      [
        "art_gallery",
        ["painting", "artist", "artwork", "canvas", "sculpture", "masterpiece"],
      ],
      [
        "historical_site",
        ["history", "ancient", "ruins", "century", "heritage", "civilization"],
      ],
      [
        "architectural_tour",
        ["building", "architecture", "design", "structure", "architect"],
      ],
    ]);
    ...
    this.topicKeywords = new Map([
      [
        "renaissance_art",
        ["leonardo", "da vinci", "michelangelo", "raphael", "renaissance"],
      ],
      [
        "modern_art",
        ["picasso", "contemporary", "modern", "abstract", "expressionism"],
      ],
      [
        "ancient_history",
        ["roman", "greek", "egypt", "ancient", "archaeology"],
      ],
    ]);
