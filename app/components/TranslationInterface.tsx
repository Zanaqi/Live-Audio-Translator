...
export default function TranslationInterface() {
  ...
  // Add this function in TranslationInterface.tsx
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="bg-indigo-600 p-6 text-white">
          ...
          <p className="text-indigo-100">Real-time translation for museum tours</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 p-6">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-700">Original Audio</h2>
            <div className="border rounded-lg p-4 min-h-[200px] bg-gray-50">
              <p className="text-gray-600">{transcript || 'Transcript will appear here...'}</p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border rounded-lg p-4 min-h-[200px] bg-gray-50">
              {isLoading ? (
                ...
                <p className="text-gray-600">{translation || 'Translation will appear here...'}</p>
              )}
            </div>
